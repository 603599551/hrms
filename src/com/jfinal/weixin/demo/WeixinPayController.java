...
public class WeixinPayController extends Controller {
    ...
    public void index() {
        ...
        params.put("mch_id", WeixinConfig.partner);
        params.put("body", "商品描述");
        params.put("out_trade_no", "977773682112");//订单号唯一
        ...
        params.put("notify_url", WeixinConfig.DOMAIN+notify_url);
        params.put("openid", openId);

        String sign = PaymentKit.createSign(params, WeixinConfig.paternerKey);
        ...
        String packageSign = PaymentKit.createSign(packageParams, WeixinConfig.paternerKey);
    ...
    public void pay_notify() {
        ...
        if(PaymentKit.verifyNotify(params, WeixinConfig.paternerKey)){
    ...
    public String getCodeUrl(String productId){
        ...
        Map<String, String> packageParams = new HashMap<String, String>();
        packageParams.put("appid", WeixinConfig.appid);
        packageParams.put("mch_id", WeixinConfig.partner);
        packageParams.put("product_id", productId);
        packageParams.put("time_stamp", timeStamp);
        packageParams.put("nonce_str", nonceStr);
        String packageSign = PaymentKit.createSign(packageParams, WeixinConfig.paternerKey);

        return String.format(url, packageSign, WeixinConfig.appid, WeixinConfig.partner, productId, timeStamp, nonceStr);
    }
    ...
    public void wxpay(){
        ...
        if (sign.equals(packageSign)) {
            ...
            String paysign = PaymentKit.createSign(params, WeixinConfig.paternerKey);
            ...
            String prepaySign = PaymentKit.createSign(prepayParams, WeixinConfig.paternerKey);
...
//		params.put("detail", "json字符串");//非必须
    ...
    public void wap1() {
        ...
        String url = PaymentApi.getDeepLink(WeixinConfig.appid, prepayId, WeixinConfig.paternerKey);
