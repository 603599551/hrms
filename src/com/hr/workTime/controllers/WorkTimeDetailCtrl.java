...
//    }
    ...
    public void getWorkTimeDetail(){
        ...
        String dictionarySearch = "select d.status_color as status_color, name1.name as '1', name2.name as '2', name3.name as '3', name4.name as '4', name5.name as '5', name6.name as '6', name7.name as '7', name8.name as '8' from (SELECT name from h_dictionary where id = '5010')name1 ,(SELECT name from h_dictionary where id = '5020')name2, (SELECT name from h_dictionary where id = '5030')name3, (SELECT name from h_dictionary where id = '5050')name4, (SELECT name from h_dictionary where id = '6010')name5, (SELECT name from h_dictionary where id = '6020')name6, (SELECT name from h_dictionary where id = '6030')name7, (SELECT name from h_dictionary where id = '6040')name8, (select status_color from h_dictionary where id = '1120')d ";
                ...
                for(int i = 0; i < workList.size(); i++){
                    if(StringUtils.equals("0", workList.get(i).getStr("is_leave"))){
                        if(StringUtils.equals("0", workList.get(i).getStr("status"))){
                            ...
                            workList.get(i).remove("is_late");
                            workList.get(i).remove("is_leave_early");
